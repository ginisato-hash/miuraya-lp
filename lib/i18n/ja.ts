...
export const ja: Dictionary = {
  ...
  facts: {
    ...
    rows: [
      ...
      { label: "設備", value: "暖房あり・冷房設備なし／木造のため音が伝わる場合あり" },
  ...
  architecture: {
    heading: "建物と時間",
    paragraphs: [
      "築70年以上の木造建築に残る柱や建具、客室の温かな佇まいを受け継ぎながら、現代の滞在に合わせて館内を改修しました。",
      "新しくしすぎず、古さをそのままにもしない。この建物に積み重なった時間を残しながら、いまの温泉街を楽しむための宿へと整えています。",
    ],
    ...
    steps: [
      {
        ...
        heading: "セルフチェックイン",
        body: [
          "客室のナンバーロック解除コードを、ご予約時に登録されたメールアドレスへ、ご宿泊前日または当日にお送りします。コードは、ご宿泊日の15:00からご利用いただけます。",
          "お送りしたコードを使って、直接お部屋へお入りください。",
        ],
      },
      {
        id: "stay",
      ...
      },
      {
        ...
        heading: "セルフチェックアウト",
        body: [
          "チェックアウト日の10:00に、客室のナンバーロック解除コードが失効し、チェックアウトとなります。",
          "お忘れ物がないことをご確認のうえ、ご出発ください。",
        ],
      },
    ],
  },
    ...
    items: [
      {
        id: "cooling",
        heading: "暖房・冷房設備について",
        body: "館内には暖房設備を備えており、冬季も暖かくお過ごしいただけます。蔵王温泉は硫黄成分を含む温泉地で、設備が腐食の影響を受けやすいため、三浦屋の客室には冷房設備を設けておりません。夏季は網戸と自然換気、扇風機でお過ごしいただきます。暑さに敏感な方や冷房を必須とされる方は、あらかじめご留意ください。",
      },
      {
        id: "sound",
        heading: "木造建築の音について",
